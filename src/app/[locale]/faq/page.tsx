...
export const metadata: Metadata = {
  title: 'FAQ - Frequently Asked Questions | Doom VIP & DH PLUS VIP IPTV',
  description: 'Get answers to common questions about our IPTV service including buffering, device support, payment methods, and technical support.',
};
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-12 pt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Contact CTA */}
        <div className="mt-16 text-center bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
