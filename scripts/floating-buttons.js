    ...
    <div id="floating-buttons" style="display: none;">
        ...
        <div class="flex flex-col space-y-3">
          ...
          <div class="relative group">
            <div class="absolute right-full ${isRTL ? 'right-auto left-full' : ''} top-1/2 -translate-y-1/2 mr-4 ${isRTL ? 'mr-0 ml-4' : ''} bg-emerald-500 text-white px-4 py-2 rounded-full shadow-lg transform translate-x-4 ${isRTL ? '-translate-x-4' : ''} opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap">
              ...
              <div class="absolute left-full ${isRTL ? 'left-auto right-full' : ''} top-1/2 -translate-y-1/2 w-0 h-0 border-t-4 border-b-4 border-l-4 ${isRTL ? 'border-l-0 border-r-4' : ''} border-transparent border-l-emerald-500 ${isRTL ? 'border-r-emerald-500' : ''}"></div>
            </div>
            ...
            <button onclick="contactWhatsApp('dh')" 
                    ...
                    aria-label="${locale === 'ar' ? 'تواصل مع دعم DH PLUS VIP' : 'Contact DH PLUS VIP support'}">
              ...
              <div class="absolute -top-1 -right-1 ${isRTL ? '-right-auto -left-1' : ''} bg-white text-emerald-600 text-xs font-bold px-1 rounded-full">
                DH
              </div>
            </button>
          </div>
          ...
          <div class="relative group">
            <div class="absolute right-full ${isRTL ? 'right-auto left-full' : ''} top-1/2 -translate-y-1/2 mr-4 ${isRTL ? 'mr-0 ml-4' : ''} bg-red-500 text-white px-4 py-2 rounded-full shadow-lg transform translate-x-4 ${isRTL ? '-translate-x-4' : ''} opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap">
              ...
              <div class="absolute left-full ${isRTL ? 'left-auto right-full' : ''} top-1/2 -translate-y-1/2 w-0 h-0 border-t-4 border-b-4 border-l-4 ${isRTL ? 'border-l-0 border-r-4' : ''} border-transparent border-l-red-500 ${isRTL ? 'border-r-red-500' : ''}"></div>
            </div>
            ...
            <button onclick="contactWhatsApp('doom')" 
                    ...
                    aria-label="${locale === 'ar' ? 'تواصل مع دعم DOOM VIP' : 'Contact DOOM VIP support'}">
              ...
              <div class="absolute -top-1 -right-1 ${isRTL ? '-right-auto -left-1' : ''} bg-white text-red-600 text-xs font-bold px-1 rounded-full">
                DM
              </div>
            </button>
          </div>
      ...
      <div class="fixed bottom-6 right-20 ${isRTL ? 'right-auto left-20' : ''} z-50">
        <button onclick="scrollToTop()" 
                ...
                aria-label="${locale === 'ar' ? 'انتقل لأعلى الصفحة' : 'Scroll to top'}">
...
module.exports = { generateFloatingButtons };
